...
export const getMCPServiceById = (id: string): MCPService | undefined => {
  return mcpServices.find(service => service.id === id);
};

export const getConnectedServices = (): MCPService[] => {
  return mcpServices.filter(service => service.isConnected);
};

export const getServicesByCategory = (category: string): MCPService[] => {
  return mcpServices.filter(service => service.category === category);
};
